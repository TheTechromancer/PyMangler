...
def gen_from_file(i, max_lines=None):
    ...
    try:
        ...
        raise AssertionError("File '{}' not found.".format(str(i)))
    except TypeError:
    ...
    try:
        ...
        if options.words is None and not options.loadfile:
            if stdin.isatty():
                ...
                options.words = [l.strip(b'\r\n').decode() for l in stdin.buffer.readlines()]
